    ...
    <div className="min-h-[calc(100vh-400px)] flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-light tracking-wider mb-2">注册</h1>
          <p className="text-primary-600">加入我们，开启时尚之旅</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          {/* 用户名 */}
          <div>
            <label className="block text-sm mb-2 tracking-wide">用户名</label>
          ...
          {/* 确认密码 */}
          <div>
            <label className="block text-sm mb-2 tracking-wide">确认密码</label>
            <div className="relative">
              <Lock
                size={20}
                className="absolute left-3 top-1/2 -translate-y-1/2 text-primary-400"
          ...
          <div className="flex items-start">
            ...
            />
            <label htmlFor="agree" className="text-sm text-primary-600">
              我已阅读并同意
              <button type="button" className="text-primary-900 hover:text-primary-600 mx-1">
                用户协议
              </button>
              和
              <button type="button" className="text-primary-900 hover:text-primary-600 ml-1">
                隐私政策
              </button>
            </label>
          </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white text-primary-600">或使用以下方式注册</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="tracking-wide">微信注册</span>
          </button>
          ...
          >
            ...
            <span className="tracking-wide">支付宝注册</span>
          </button>

          <button
            type="button"
            onClick={() => handleThirdPartyRegister('手机号')}
            className="w-full flex items-center justify-center px-6 py-3 border border-primary-300 hover:bg-primary-50 transition-colors duration-300"
          >
            <Smartphone size={20} className="mr-2" />
            <span className="tracking-wide">手机号注册</span>
          </button>
        </div>
